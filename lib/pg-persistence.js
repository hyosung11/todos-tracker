...
module.exports = class PgPersistence {
  ...
  /* Returns a copy of the todo list with the indicated ID. Returns `undefined` if not found. Note that `todoListId` must be numeric. */
  ...
  /* Returns a copy of the list of todos in the indicated todo list sorted by completion status and title (case-insensitive). */
